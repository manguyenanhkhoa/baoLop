      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/90 backdrop-blur">
        <div className="mx-auto flex max-w-[90rem] items-center gap-4 px-4 py-3 sm:px-6">
          ...
          <form onSubmit={onSearch} className="relative hidden flex-1 md:block">
            ...
            <input value={query} onChange={e => setQuery(e.target.value)} placeholder="Tìm mô hình, sa bàn, xe 1:64, 1:34..." className="w-full rounded-full border border-border bg-secondary py-2 pl-10 pr-4 text-sm outline-none focus:border-primary" />
          </form>
