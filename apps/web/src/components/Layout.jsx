...
import { ShoppingCart as CartIcon, Search, Boxes, User, LayoutDashboard, Menu, LogOut } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/90 backdrop-blur">
        <div className="mx-auto flex max-w-[90rem] items-center gap-3 px-4 py-3 sm:gap-4 sm:px-6">
          ...
          <Link to="/" className="flex shrink-0 items-center gap-2">
            <Boxes className="h-6 w-6 text-primary sm:h-7 sm:w-7" />
      ...
      <footer className="border-t border-border bg-card">
        <div className="mx-auto grid max-w-[90rem] gap-8 px-6 py-12 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground">Chuyên mô hình, sa bàn và xe die-cast tỉ lệ 1:64, 1:32 chính hãng, chất lượng cao.</p>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/store?category=1:32" className="hover:text-primary">Xe 1:32</Link></li>
              <li><Link to="/store?category=diorama" className="hover:text-primary">Sa bàn / Diorama</Link></li>
            </ul>
          </div>
          <div>
